...
try {
    ...
    $mail->CharSet = 'UTF-8';
    //Recipients
    $mail->setFrom('phamthokd@gmail.com', 'Văn phòng Khoa CNTT - Trường ĐH Thủy lợi');

    $mail->addReplyTo('phamthokd@gmail.com', 'Văn phòng Khoa CNTT - Trường ĐH Thủy lợi');
      
    $mail->addAddress('phamthokd@gmail.com'); // Add a recipient
